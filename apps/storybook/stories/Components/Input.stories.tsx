import eyeIcon from '@pplancq/shelter-ui-icon/icon/eye.svg';
import searchIcon from '@pplancq/shelter-ui-icon/icon/search.svg';
...
export const Playground: Story = {
  tags: ['dev'],
  render: ({ startAdornment, endAdornment, placeholder, ...args }) => (
    <Input
      {...args}
